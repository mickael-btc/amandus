...
class MIMEParser {
        ...
        case "body": // process body section
          ...
          if (this._node.parentBoundary && (line === "--" + this._node.parentBoundary || line === "--" + this._node.parentBoundary + "--")) {
            if (
              ...
              (!this._node.parsedHeader["content-transfer-encoding"] || ["7bit", "8bit", "binary"].includes(this._node.parsedHeader["content-transfer-encoding"]))
            ) {
  ...
  processNodeHeader() {
    ...
    ["in-reply-to", "message-id", "content-transfer-encoding", "content-id", "content-description", "content-language", "content-md5", "content-location"].forEach((key) => {
      if (Array.isArray(this._node.parsedHeader[key])) {
